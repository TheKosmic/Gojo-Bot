...
title: "VER LISTA",
description: "Infórmate por medios oficiales sobre GojoBot",
sections: [
{ title: "ℹ️ Información", highlight_label: "Popular",
rows: [
{ header: "✅ Redes", title: "🔓 Para: Todos", description: "Infórmate por medios oficiales sobre GojoBot", id: usedPrefix + "cuentasgb" },
{ header: "📢 Grupos/Canales", title: "🔓 Para: Todos", description: "¡Te esperamos!", id: usedPrefix + "grupos" },
{ header: "🎁 Donar", title: "🔓 Para: Todos", description: "GojoBot se mantiene funcionando gracias a donaciones ¡tú también puedes sumarte apoyando el proyecto!", id: usedPrefix + "donar" }
]},
...
{ header: "😺 Estado", title: "🔓 Para: Todos", description: "Conoce en que estado se encuentra GojoBot", id: usedPrefix + "estado" }
]},
...
┃
┃✅ *_CUENTAS OFICIALES GOJOBOT_* ✅
┃➺ _${usedPrefix}cuentasgojobot | cuentasgb_
┃
*╰━━━━━━━━━━━━━⬣*`.trim()
